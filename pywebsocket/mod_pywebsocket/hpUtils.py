...
import iptc
'''
A suite of functions, built on top of the python-iptables module (iptc),
to streamline on the fly management of iptables.
...
def allowSpecificWebsite(anIP):
	...
	'''
	# to do (extension): need to allow DNS
