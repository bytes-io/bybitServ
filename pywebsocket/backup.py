...
def messageClassifer(msg, phase, pubArr, aController, paymentNo):
    if phase==0:
        ...
        # print 'sigC: ', sigServer
        sigClient = msg +'01'
        print 'sigClient: ', sigClient
        ...
        aController.notify(signedPayment, None, 3777)
        # print 'signedPayment: ', signedPayment
        # if paymentNo[0] == 3: aController.pushPayment()
        # if paymentNo[0] == 3: bitcoin.pushtx(signedPayment)
        print 'ALLGOOOD!'
    return phase
